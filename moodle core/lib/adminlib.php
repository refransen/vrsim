...
// Specifically allows access to the "upload users"via CSV function
//
// @global moodle_page $PAGE
// 
// @param string $section name of page
...
//      pagelayout - This option can be used to set a specific pagelyaout, admin is default.
////////////////////////////////////////////////////////////////////////////////////////
function teacher_uploadUsers_setup($section, $extrabutton = '', array $extraurlparams = null, $actualurl = '', array $options = array()) {
    global $CFG, $PAGE, $USER, $SITE, $OUTPUT;
    ...
    $pageName = "Upload new users";
    $pageURL = new moodle_url('/admin/tool/uploaduser/teacher_index.php');
