...
$string['defaultmaxcourses'] = 'Voreinstellung Höchstzahl der Kurse';
...
$string['forcedefaultmaxcoursesdesc'] = 'Wenn dies festgelegt wird, können Nutzer/innen keine individuellen Einstellungen vornehmen';
...
$string['shortnamesufixprural'] = '(and {$a} weitere)';
$string['shortnamesufixsingular'] = '(and {$a} weitere)';
