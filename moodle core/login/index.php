...
if ($frm and isset($frm->username)) {                             // Login WITH cookies
    ...
    /// Prepare redirection
        ...
        //====================================
        // Rachel Fransen - March 10, 2013
        // Integrated this patch: https://tracker.moodle.org/browse/MDL-37983
        // to allow "user preference" for homepage to work with the "forced login" setting
        //====================================
        ...
        if ($urltogo == ($CFG->wwwroot . '/')) 
        {
		    ...
		    // Rachel Fransen - March 17, 2013
                    ...
                    // are directed to the mymoodle page. Then I redirect to their course.
