...
/**
 * Strings for component 'vrlesson', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   vrlesson
...
$string['availabletags_help'] = 'Tags are placeholders in the template, which will be replaced by data or other items, such as an edit icon, when projects are edited or viewed.
...
$string['cannotadd'] = 'Can not add projects!';
...
$string['configenablerssfeeds'] = 'This switch will enable the possibility of RSS feeds for all vrlessons. You will still need to turn feeds on manually in the settings for each vrlesson.';
...
$string['csvimport_help'] = 'Projects may be imported via a plain text file with a list of field names as the first line, then the data, with one record per line.';
$string['csvwithselecteddelimiter'] = '<acronym title="Comma Separated Values">CSV</acronym> text with selected delimiter:';
$string['vrlesson:addinstance'] = 'Add a new vrlesson';
$string['vrlesson:approve'] = 'Approve unapproved projects';
$string['vrlesson:comment'] = 'Write comments';
$string['vrlesson:exportallentries'] = 'Export all projects';
$string['vrlesson:exportentry'] = 'Export a project';
$string['vrlesson:exportownentry'] = 'Export own project entry';
$string['vrlesson:exportuserinfo'] = 'Export user information';
$string['vrlesson:managecomments'] = 'Manage comments';
$string['vrlesson:manageentries'] = 'Manage project entries';
$string['vrlesson:managetemplates'] = 'Manage templates';
$string['vrlesson:manageuserpresets'] = 'Manage all template presets';
$string['vrlesson:rate'] = 'Rate projects';
$string['vrlesson:readentry'] = 'Read projects';
$string['vrlesson:viewalluserpresets'] = 'View presets from all users';
$string['vrlesson:viewallratings'] = 'View all raw ratings given by individuals';
$string['vrlesson:viewanyrating'] = 'View total ratings that anyone received';
$string['vrlesson:viewentry'] = 'View projects';
$string['vrlesson:viewrating'] = 'View the total rating you received';
$string['vrlesson:writeentry'] = 'Write projects';
$string['date'] = 'Date';
...
$string['entries'] = 'Projects';
$string['entrieslefttoadd'] = 'You must add {$a->entriesleft} more project/projects in order to complete this lesson';
$string['entrieslefttoaddtoview'] = 'You must add {$a->entrieslefttoview} more project/projects before you can view other participants\' projects.';
$string['entry'] = 'Entry';
...
$string['example'] = 'VRlesson module example';
$string['excel'] = 'Excel';
...
$string['exportentries'] = 'Export projects';
$string['exportownentries'] = 'Export your own projects only? ({$a->mine}/{$a->all})';
...
$string['headeraddtemplate'] = 'Defines the interface when editing projects';
...
$string['headerlisttemplate'] = 'Defines browsing interface for multiple projects';
$string['headerrsstemplate'] = 'Defines appearance of projects in RSS feeds';
...
$string['expired'] = 'Sorry, this lesson closed on {$a} and is no longer available';
$string['importentries'] = 'Import projects';
...
$string['insufficiententries'] = 'more projects needed to view this database';
...
$string['latlongdownloadallhint'] = 'Download link for all projects as KML';
...
$string['maxentries'] = 'Maximum projects';
$string['maxentries_help'] = 'The maximum number of projects a student is allowed to submit for this lesson.';
$string['maxsize'] = 'Maximum size';
$string['menu'] = 'Menu';
$string['menuchoose'] = 'Choose...';
$string['missingdata'] = 'VRlesson id or object must be provided to field class';
$string['missingfield'] = 'Programmer error: You must specify field and/or data when defining field class.';
$string['modulename'] = 'VRLesson';
$string['modulename_help'] = 'The vrlesson module enables participants to create, maintain and search a collection of projects(i.e. records).  The structure of the projects is defined by the teacher as a number of fields. Field types include checkbox, radio buttons, dropdown menu, text area, URL, picture, bendicon and uploaded file.

The visual layout of information when listing, viewing or editing projects may be controlled by lesson templates. VRLessons may be shared between courses as presets and a teacher may also import and export projects.

If the database auto-linking filter is enabled, any projects in a lesson will be automatically linked where the words or phrases appear within the course.

A teacher can allow comments on projects. Entries can also be rated by teachers or students (peer evaluation). Ratings can be aggregated to form a final grade which is recorded in the gradebook.
...
$string['modulename_link'] = 'mod/vrlesson/view';
$string['modulenameplural'] = 'VRlessons';
$string['more'] = 'More';
...
$string['namebendicon'] = 'Bendicon field';
...
$string['newfield_help'] = 'A field allows the input of data. Each entry in a vrlesson activity can have multiple fields of multiple types such as a date field, which allows participants to select a day, month and year from a dropdown list, a picture field, which allows participants to upload an image file, or a checkbox field, which allows participants to select one or more options.
...
$string['nomatch'] = 'No matching projects found!';
$string['nomaximum'] = 'No maximum';
$string['norecords'] = 'No projects in lesson';
...
$string['notopenyet'] = 'Sorry, this lesson is not available until {$a}';
$string['number'] = 'Number';
$string['numberrssarticles'] = 'RSS articles';
$string['numnotapproved'] = 'Pending';
$string['numrecords'] = '{$a} projects';
...
$string['page-mod-vrlesson-x'] = 'Any vrlesson activity module page';
$string['pagesize'] = 'Projects per page';
$string['participants'] = 'Participants';
$string['picture'] = 'Picture';
$string['bendicon'] = 'Bend Icon';
$string['pleaseaddsome'] = 'Please create some below or <a href="{$a}">choose a predefined set</a> to get started.';
$string['pluginadministration'] = 'VRlesson activity administration';
$string['pluginname'] = 'VRlesson';
$string['portfolionotfile'] = 'Export to a portfolio rather than a file (csv and leap2a only)';
$string['presetinfo'] = 'Saving as a preset will publish this template. Other users may be able to use it in their vrlessons.';
...
$string['recordssaved'] = 'projects saved';
$string['recordsupdated'] = 'projects updated';
$string['requireapproval'] = 'Require approval?';
$string['requireapproval_help'] = 'If enabled, projects require approving by a teacher before they are viewable by everyone.';
$string['requiredentries'] = 'Required projects';
$string['requiredentries_help'] = 'The number of projects a student is required to submit before the lesson can be considered complete.';
$string['requiredentriestoview'] = 'Projects required before viewing';
$string['requiredentriestoview_help'] = 'The number of projects a student is required to submit before they can view projects from other students.

Note: If projects are required before viewing, the vrlesson auto-linking filter should be disabled. This is because the vrlesson auto-linking filter can\'t determine whether a user has submitted the required number of projects.';

$string['reportlesson'] = 'Lesson Report';   // Added by Rachel Fransen - used in VRlesson reports
$string['reportproject'] = 'Project Report';  // Added by Rachel Fransen - used in VRlesson reports
...
$string['showall'] = 'Show all projects';
$string['single'] = 'View single';
$string['singletemplate'] = 'Single template';
$string['subplugintype_datafield'] = 'VRlesson field type';
$string['subplugintype_datafield_plural'] = 'VRlesson field types';
...
$string['todatabase'] = 'to this lesson.';
$string['type'] = 'Field type';
$string['undefinedprocessactionmethod'] = 'No action method defined in VRlesson_Preset to handle action "{$a}".';
$string['unsupportedexport'] = '({$a->fieldtype}) cannot be exported.';
$string['updatefield'] = 'Update an existing field';
$string['uploadfile'] = 'Upload file';
$string['uploadrecords'] = 'Upload projects from a file';
$string['uploadrecords_help'] = 'Projects may be uploaded via text file. The format of the file should be as follows:
...
$string['uploadrecords_link'] = 'mod/vrlesson/import';
$string['url'] = 'Url';
...
$string['userlist'] = 'Choose student';         // Rachel Fransen - added a selectbox to import form
$string['wronguserlist'] = "Please choose a student for this import file";    // Rachel Fransen - error message for import form
$string['nofilefound'] = "Please choose a file to import";     // Rachel Fransen - error message for import form

$string['viewfromdate'] = 'Read only from';
$string['viewtodate'] = 'Read only to';
$string['wrongdataid'] = 'Wrong vrlesson id provided';