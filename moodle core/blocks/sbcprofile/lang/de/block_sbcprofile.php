...
/**
 * Strings for component 'block_sbcprofile', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    block
 * @subpackage sbcprofile
 * @copyright  2010 Remote-Learner.net
 * @author     Rachel Fransen 2013, Olav Jordan <olav.jordan@remote-learner.ca>
...
$string['display_description'] = 'Display profile description';
...
$string['sbcprofile:addinstance'] = 'Add a new logged in user block';
$string['sbcprofile:myaddinstance'] = 'Add a new logged in user block to the My Moodle page';
$string['sbcprofile_settings'] = 'Visible user information';
$string['pluginname'] = 'SBC Profile';

// RF - July 2013
// Custom elements
$string['viewprofile'] = 'Anzeigen Profil';
$string['viewmessages'] = 'Anzeigen Nachrichten';
