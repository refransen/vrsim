...
// RANCH - This displays the overview block
///////////////////////////////////////////////////////
require_once(dirname(__FILE__) . '/../../../../config.php');

$PAGE->requires->js('/local/simbuild/student/ranch/workorders.js');
...
$siteName = "SITE_RANCH_HOUSE";
$siteID = 0;
$siteGUID = "ws-demosite2";
...
echo '
<div class="topinfo">
    	<img src="/theme/simbuild/pix/progressreport/Site_RanchHouse.png" />
	<div class="titles" >
	    <h3>Work Site:</h3>
