...
<head>
    ...
    <?php echo '<link rel="stylesheet" type="text/css" href="'.$CFG->wwwroot.'/theme/simbuild/style/login.css">'; ?>
...
<?php if ($hasfooter) { ?>
	<div id="page-footer" class="wrapper">
		<div class="copyright">©2013-2014 VRSIM Learning Management System</div>
		<?php
