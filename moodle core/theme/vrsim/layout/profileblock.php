...
{
        ////////////////////////  Rachel Feb.28, 2013 /////////////////////////////////
        // Removed the login area in the top nav bar. If not logged in, only use default login page
        ///////////////////////////////////////////////////////////////////////////////
...
/*
echo '<a id="imageDivLink" href="javascript:toggle5('profilebar', 'imageDivLink');">
      <img src="<?php echo $OUTPUT->pix_url("profile/down", "theme")?>" /></a>';
*/

// Rachel Fransen - March 31, 2013
// Write my own links
//-------------------------------
echo html_writer::start_tag('div', array('class'=>'mylinks'));
