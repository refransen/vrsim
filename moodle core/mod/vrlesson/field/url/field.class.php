...
class vrlesson_field_url extends vrlesson_field_base {
    var $type = 'url';
    ...
    function display_add_field($recordid=0) {
        ...
        $module = array('name'=>'vrlesson_urlpicker', 'fullpath'=>'/mod/data/data.js', 'requires'=>array('core_filepicker'));
        $PAGE->requires->js_init_call('M.vrlesson_urlpicker.init', array($options), true, $module);
