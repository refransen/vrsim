...
/**
 * Strings for component 'block_course_outline', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   block_course_outline
...
$string['course_outline:addinstance'] = 'Add a new courses block';
$string['course_outline:myaddinstance'] = 'Add a new courses block to the My Moodle page';
