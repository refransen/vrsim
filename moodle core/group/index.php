...
echo format_string($course->shortname, true, array('context' => $context)) .' '.$strgroups.'</h3>';
...
echo '</select>'."\n";
echo '<p><input type="submit" name="act_updatemembers" id="updatemembers" class="createbutton" value="'
        . get_string('showmembersforgroup', 'group') . '" /></p>'."\n";

echo '<p><input type="submit" '. $showeditgroupsettingsform_disabled . ' name="act_showgroupsettingsform" id="showeditgroupsettingsform" class="createbutton" value="'
        . get_string('editgroupsettings', 'group') . '" /></p>'."\n";

echo '<p><input type="submit" '. $deletegroup_disabled . ' name="act_deletegroup" id="deletegroup" class="createbutton" value="'
        . get_string('deleteselectedgroup', 'group') . '" /></p>'."\n";

echo '<p><input type="submit" name="act_showcreateorphangroupform" id="showcreateorphangroupform" class="createbutton" value="'
...
echo '<p><input type="submit" ' . $showaddmembersform_disabled . ' name="act_showaddmembersform" '
        . 'id="showaddmembersform" class="createbutton" value="' . get_string('adduserstogroup', 'group'). '" /></p>'."\n";
