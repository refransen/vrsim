...
$string['uploadusers_helpText'] = '<br /><span style="font-size:12px;" >Click on the help icon for an example format</span>';
$string['uploadusers'] = 'Upload users';
$string['uploadusers_help'] = 'Users may be uploaded (and optionally enrolled in courses) via text file. The format of the file should be as follows: <br /><br />
<span style="font-family:Verdana, Geneva, sans-serif;" >
* The first line of the file contains a list of fieldnames that define the format <br />
* Each line of the file contains one record <br />
* Each record is a series of data separated by commas (or other delimiters) <br />
* Required fieldnames are: firstname, lastname, username, email, course1 <br />
* Leave the username, password(option), and course1 fields empty. This information will be generated automatically<br />
* See the example below: <br /><br />
</span>
<img src="/theme/vrsim/pix/UploadUser_CsvExample.jpg" width="380" />';
