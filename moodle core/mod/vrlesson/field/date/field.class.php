...
class vrlesson_field_date extends vrlesson_field_base  {
    ...
    function display_add_field($recordid=0) {
        ...
        if ($recordid) {
            $content = (int)$DB->get_field('vrlesson_content', 'content', array('fieldid'=>$this->field->id, 'recordid'=>$recordid));
        } else {
            $content = time();
        }
    ...
    function display_search_field($value=0) {
        ...
        $str = $selectors . ' ' . $datecheck . ' ' . get_string('usedate', 'vrlesson');
    ...
    function display_browse_field($recordid, $template) {
        ...
        if ($content = $DB->get_field('vrlesson_content', 'content', array('fieldid'=>$this->field->id, 'recordid'=>$recordid))) {
