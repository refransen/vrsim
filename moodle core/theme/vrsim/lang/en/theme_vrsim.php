<?php
$string['pluginname'] = 'VRSim';
$string['region-side-post'] = 'Right';
$string['region-side-pre'] = 'Left';
$string['choosereadme'] = 'VRSim is a three column fixed-width theme for Moodle 2.1+ originally created by Rachel Fransen for <a href="http://www.vrsim.net">VRSim</a>';

$string['configtitle'] = 'vrsim theme';
...
$string['menubackcolor'] = 'Menu Gradient: Start Colour';
$string['menubackcolordesc'] = 'Change the highlight color of menu gradient';

$string['endcolor'] = 'Menu gradient: End Color';
$string['endcolordesc'] = 'Change the shadow color of the menu gradient';
