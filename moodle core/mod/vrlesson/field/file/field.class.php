...
class vrlesson_field_file extends vrlesson_field_base {
    var $type = 'file';
    ...
    function display_add_field($recordid=0) {
        ...
        $module = array('name'=>'vrlesson_filepicker', 'fullpath'=>'/mod/vrlesson/data.js', 'requires'=>array('core_filepicker'));
        $PAGE->requires->js_init_call('M.vrlesson_filepicker.init', array($fp->options), true, $module);
