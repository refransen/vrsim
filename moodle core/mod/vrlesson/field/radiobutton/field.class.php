...
class vrlesson_field_radiobutton extends vrlesson_field_base {
    ...
    function display_add_field($recordid=0) {
        ...
        if ($recordid){
            $content = trim($DB->get_field('vrlesson_content', 'content', array('fieldid'=>$this->field->id, 'recordid'=>$recordid)));
        } else {
            $content = '';
        }
