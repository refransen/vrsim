...
/**
 * Strings for component 'block_groups', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['groups:addinstance'] = 'Add a new groups block';
$string['groups:myaddinstance'] = 'Add a new groups block to the My Moodle page';
$string['hideallcourseslink'] = 'Hide All courses link';
$string['owncourses'] = 'Admin user sees own courses';
$string['pluginname'] = 'Groups';
$string['blocktitle'] = 'My Classes';