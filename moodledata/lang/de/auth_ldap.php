...
$string['auth_ntlmsso_remoteuserformat'] = 'Wenn Sie  \'NTLM\'als \'Authentifizierungstyp\' verwenden können Sie hier das enfernte Nutzernamenformat festlegen. Bleibt der Eintrag leer wird das Standard Nutzernamenformat verwendet. Verwenden Sie den optionalen <b>%domain%</b> Platzhalter, um festzulegen wo der Domainname erscheint und den erforderlichen Platzhalter <b>%username%</b> für den Nutzernamenort. <br /><br />Häufig genutzte Formate sind <tt>%domain%%username%</tt> (MS Windows default), <tt>%domain%/%username%</tt>, <tt>%domain%+%username%</tt> und einfach <tt>%username%</tt> (wenn kein Domainteil verwandt wird).';
