...
class vrlesson_field_multimenu extends vrlesson_field_base {
    ...
    function display_search_field($value = '') {
        ...
        $str .= html_writer::checkbox('f_'.$this->field->id.'_allreq', null, $allrequired, get_string('selectedrequired', 'vrlesson'));
    ...
    function update_content($recordid, $value, $name='') {
        ...
        $content->content  = $this->format_vrlesson_field_multimenu_content($value);
    ...
    function format_vrlesson_field_multimenu_content($content) {
        if (!is_array($content)) {
            return NULL;
        }
        $options = explode("\n", $this->field->param1);
