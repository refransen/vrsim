...
class vrlesson_field_menu extends vrlesson_field_base {
    ...
    function display_add_field($recordid=0) {
        ...
        $str .= html_writer::label(get_string('menuchoose', 'vrlesson'), 'field_'.$this->field->id, false, array('class' => 'accesshide'));
        $str .= html_writer::select($options, 'field_'.$this->field->id, $content, array(''=>get_string('menuchoose', 'vrlesson')), array('id'=>'field_'.$this->field->id));
    ...
    function display_search_field($content = '') {
        ...
        $return = html_writer::label(get_string('namemenu', 'vrlesson'), 'menuf_'. $this->field->id, false, array('class' => 'accesshide'));
