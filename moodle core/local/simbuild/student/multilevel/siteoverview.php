...
// MULTILEVEL - This displays the overview block
///////////////////////////////////////////////////////
require_once(dirname(__FILE__) . '/../../../../config.php');

$PAGE->requires->js('/local/simbuild/student/multilevel/workorders.js');
...
{
    // FIX: Find a better way to remove bad systems
    if($singleSys->desc == "SYSTEM_DEMO")
    { continue; }
...
$progressArr = array(100,50,0,0,0,0,0,0,0);
...
echo '
<div class="topinfo">
    	<img src="/theme/simbuild/pix/progressreport/Site_MultiLevel.png" />
	<div class="titles" >
	    <h3>Work Site:</h3>
