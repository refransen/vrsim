...
$string['notwritable_help'] = 'Sie haben die automatische Bereitstellung von Plugin-Updates aktiviert. Für dieses Pligin steht ein Update zur Verfügung. Die Plugin-Dateien auf dem Server können jedoch nicht überschrieben werden. Das automatische Update kann daher nicht ausgeführt werden.
Sie müssen das Plugin-Verzeichnis so anpassen, dass auf dem Server Schreibrechte gesetzt werden. Danach kann ein automatisches Update ausgeführt werden.';
...
$string['pluginchecknotice'] = 'Diese Seite zeigt Plugins, die eine Mitteilung senden. Markiert sind neue Plugins, aktualisierbare Plugins und fehlende Plugins. Die neuen Versionen dieser Plugins sollten Sie vor der Aktualisierung von Moodle laden.';
...
$string['somehighlighted'] = 'Anzahl der Plugins, die Ihre Beachtung fordern: {$a}';
$string['somehighlightedinfo'] = 'Liste aller installierten Plugins zeigen';
$string['somehighlightedonly'] = 'Nur Plugins anzeigen, die Aufmerksamkeit erfordern';
...
$string['updatepluginconfirmexternal'] = 'Die derzeitige Version des Plugins wurde anscheinend vom Programmcode-Verwaltungssystem {$a} bezogen. Wenn Sie dieses Update installieren werden Sie nicht mehr in der Lage sein, dieses Verwaltungssystem für Programmcode zu verwenden. Bitte bestätigen Sie dies, bevor Sie fortfahren.';
$string['updatepluginconfirminfo'] = 'Sie haben damit begonnen eine neue Version des Plugins <strong> {$a->name}</strong> zu installieren. Ein Zip-Paket mit der Version {$a->version} des Plugins wird von <a href="{$a->url}">{$a->url}</a> heruntergeladen und für Ihre Moodle-Installation entpackt. Dann erfolgt das Upgrade des Plugins.';
$string['updatepluginconfirmwarning'] = 'Vor der Aktualisierung wird keine automatische Datenbanksicherung durchgeführt. Der neue Code könnte die Datenbank beschädigen.';
