...
else if ($mycourses = enrol_get_all_users_courses($user->id, true, NULL, 'visible DESC,sortorder ASC')) 
{
     $myroleString = '';
...
// RF - July 2013
// Print a blank space for formatting
print_row("", "");
...
if ($user->skype && !isset($hiddenfields['skypeid'])) {
    ...
    print_row('<img src="/theme/simbuild/pix/social/skypeIcon.png" />'.get_string('skypeid').':','<a href="skype:'.urlencode($user->skype).'?call">'.s($user->skype).$statusicon.'</a>');
}
