...
class vrlesson_field_checkbox extends vrlesson_field_base {
    ...
    function update_content($recordid, $value, $name='') {
        ...
        $content->content = $this->format_vrlesson_field_checkbox_content($value);
    ...
    function format_vrlesson_field_checkbox_content($content) {
        if (!is_array($content)) {
            return NULL;
        }
        $options = explode("\n", $this->field->param1);
