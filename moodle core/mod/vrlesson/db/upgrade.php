...
function xmldb_data_upgrade($oldversion) {
    ...
    if ($oldversion < 2012112901) {
        ...
        $olddatadir = $CFG->dataroot . '/vrlesson';
            ...
            foreach ($userfolders as $userfolder) {
                ...
                foreach ($presetfolders as $presetfolder) {
                    ...
                    foreach ($presetfiles as $file) {
                        ...
                        if (!$fs->file_exists($context->id, 'mod_vrlesson', 'site_presets', 0, '/' . $presetfolder . '/', $filename)) {
        ...
        upgrade_mod_savepoint(true, 2012112901, 'vrlesson');
    }
