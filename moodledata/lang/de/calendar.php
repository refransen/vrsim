...
$string['hideglobalevents'] = 'Globale Termine verbergen';
$string['hidegroupsevents'] = 'Gruppentermine verbergen';
$string['hideuserevents'] = 'Persönliche Termine verbergen';
...
$string['importfrominstructions'] = 'Bitte geben Sie die URL zu einem externen Kalender an oder laden Sie eine Datei hoch.';
...
$string['pollinterval_help'] = 'Wie oft möchten Sie den Kalender hinsichtlich neuer Termine aktualisieren?';
...
$string['showglobalevents'] = 'Globale Termine anzeigen';
$string['showgroupsevents'] = 'Gruppentermine anzeigen';
$string['shown'] = 'angezeigt';
$string['showuserevents'] = 'Persönliche Termine anzeigen';
