...
/**
 * Strings for component 'moodle', language 'de', branch 'MOODLE_24_STABLE'
 *
 * @package   moodle
...
$string['addpagehere'] = 'Textseite hier hinzufügen';
...
$string['blockdeleteconfirm'] = 'Soll der Block \'{$a}\' vollständig gelöscht werden? Damit werden alle Datenbankeinträge gelöscht, die zu diesem Block gehören. Soll dieser Vorgang wirklich fortgesetzt werden?';
$string['blockdeletefiles'] = 'Alle zum Block \'{$a->block}\' gehörenden Daten wurden aus der Datenbank gelöscht. Um den Vorgang abzuschließen, muss das Verzeichnis \'{$a->directory}\' auf dem Server gelöscht werden, andernfalls wird der Block automatisch neu installiert.';
...
$string['cookiesenabled_help'] = 'Diese Website benutzt zwei Cookies:

Das wichtigste Cookie heißt <b>MoodleSession</b>. Sie müssen erlauben, dass Ihr Browser dieses Cookie speichern darf, damit Ihr Login in Moodle von Seite zu Seite erhalten bleibt. Nach dem Ausloggen oder dem Schließen Ihres Webbrowsers wird das Cookie automatisch gelöscht.</p>

Das andere Cookie dient Ihrer Bequemlichkeit. Es speichert den Anmeldenamen im Webbrowser und heißt standardmäßig <b>MoodleID</b>. Dieses Cookie speichert Ihren Anmeldenamen und bleibt auch nach dem Ausloggen erhalten. Wenn Sie dieses Cookie nicht erlauben, müssen Sie Ihren Anmeldenamen bei jedem Einloggen neu eingeben.';
...
$string['coursehelpforce'] = 'Der Gruppenmodus wird für alle Aktivitäten des Kurses vorgegeben.';
...
$string['dndenabled'] = 'Drag&Drop ist möglich';
$string['dndenabled_help'] = 'Markieren Sie mit der linken Maustaste eine oder mehrere Dateien im Dateisystem Ihres Rechners. Ziehen Sie dieses bei gedrückter Maustaste in dieses Feld und lassen Sie die Taste los. Danach werden die Dateien hochgeladen. Große Dateimengen brauchen etwas Zeit. Haben Sie Geduld. Drag&Drop wird nicht von allen Browsern unterstützt.';
$string['dndenabled_inbox'] = 'Bewegen Sie Dateien in dieses Feld (Drag&Drop)';
$string['dndenabled_insentence'] = 'Drag&Drop ist möglich';
...
$string['errortoomanylogins'] = 'Sie haben die zulässige Anzahl erfolgloser Zugangsversuche überschritten. Für weitere Versuche müssen Sie Ihren Browser neu starten';
...
$string['failedloginattempts'] = '{$a->attempts} gescheiterte Logins';
...
$string['frontpagedescriptionhelp'] = 'Diese Informationen zur Website werden auf der Startseite angezeigt, entweder im Block \'Informationen\' oder in einen zentralen Themenabschnitt.';
...
$string['frontpagetopiconly'] = 'Themenabschnitt';
...
$string['nameforpage'] = 'Wie möchten Sie diese Textseite nennen?';
...
$string['returntomaincoursepage'] = 'Zurück zur Kursübersicht';
